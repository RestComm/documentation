...
** link:http://documentation.telestax.com/core/smpp-extensions/SMPP_Extensions_Installation_Guide.html[Restcomm SMPP Extensions Installation Guide]

** link:http://documentation.telestax.com/core/smpp-extensions/SMPP_Extensions_User_Guide.html[Restcomm SMPP Extensions User Guide]
